  ...
  return (
    <body>
      ...
      <div class="container">
        <div class="form">
          <div>
            <h1 class="main-head">EditStudent</h1>

            <form onSubmit={handleSubmit(onSubmit)}>
              <div class="divtype1">
                <label htmlFor="name">Name:</label>
                <input  class="inputtext" type="text" id="name" {...register("name")} />
              ...
              <div class="divtype2" >
                ...
                <input  class="inputtext" type="text" id="regNo" {...register("regNo")} />
                <p>{errors.regNo?.message}</p>
              </div>
              <div class="divtype1">
                <label htmlFor="address">Address:</label>
                <input  class="inputtext" type="text" id="address" {...register("address")} />
              ...
              <div class="divtype1">
                ...
                <input
                 class="inputtext"
                  ...
                  {...register("relationshipWithGuardian")}
                />
              ...
              <div class="divtype1">
                ...
                <input  class="inputtext" type="email" id="email" {...register("email")} />
              ...
              <div class="divtype2">
                ...
                <input   class="inputtext" type="text" id="plusTwo" {...register("plusTwo")} />
                <p>{errors.plusTwo?.message}</p>
              </div>
              <div class="divtype1">
                <label htmlFor="stream">Stream:</label>
                <input   class="inputtext" type="text" id="stream" {...register("stream")} />
              ...
              {semestersData.map((semester, index) => (
                <div  key={index}>
                  ...
                  <div>
                    {semester.subjects.map((subject, subjectIndex) => (
                      <div key={subjectIndex}>
                        ...
                        <button
                          type="button"
                          onClick={() =>
                            removeSubject(semester.semesterNumber, subjectIndex)
                          }
                        >
                          Remove Subject
                        </button>
                    ...
                    <button
                      type="button"
                      onClick={() => openModal(semester.semesterNumber)}
                    >
                      Add Subject
                    </button>
                  </div>
